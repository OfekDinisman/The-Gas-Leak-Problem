...
QUERY_SCHED_SA_STD = "SELECT Id, Longitude, Latitude, EarliestStartTime, Simulation_Dataset__c, WorkType.Name, ServiceTerritoryId, SchedStartTime, SchedEndTime, Assigned_Service_Resource__c FROM ServiceAppointment WHERE WorkType.Name='Standard' and SchedStartTime!=null and Simulation_Dataset__c='%s' ORDER BY Assigned_Service_Resource__c, SchedStartTime"
